...
from rotten_tomatoes_python_sdk.exceptions_base import ApiValueError
from rotten_tomatoes_python_sdk.exceptions import ClientConfigurationError
...
conf = rotten_tomatoes_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "http://api.rottentomatoes.com/api/public/v1.0" if host is None else host
        """Default Base url
        """
        ...
        if key:
            ...
            raise ClientConfigurationError('API Key "key" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("rotten_tomatoes_python_sdk")
