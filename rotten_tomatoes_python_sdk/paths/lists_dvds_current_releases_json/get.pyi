...
class BaseApi(api_client.Api):
    ...
    def _get_current_releases_mapped_args(
        self,
    ...
    async def _aget_current_releases_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/dvds/current_releases.json',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_current_releases_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCurrentReleasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_current_releases(
        self,
        page_limit: typing.Optional[str] = None,
        page: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_current_releases_mapped_args(
            page_limit=page_limit,
            page=page,
            country=country,
        )
        return await self._aget_current_releases_oapg(
    ...
    def get_current_releases(
        ...
        return self._get_current_releases_oapg(
            query_params=args.query,
        )

class GetCurrentReleases(BaseApi):
    ...
    async def aget_current_releases(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_current_releases(
            page_limit=page_limit,
            page=page,
            country=country,
            **kwargs,
    ...
    def get_current_releases(
        ...
        raw_response = self.raw.get_current_releases(
            page_limit=page_limit,
            page=page,
            country=country,
        )
