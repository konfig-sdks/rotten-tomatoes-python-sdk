...
class BaseApi(api_client.Api):
    ...
    def _get_dvds_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_dvds_oapg(
        self,
...
class GetDvdsRaw(BaseApi):
    ...
    async def aget_dvds(
        ...
        **kwargs,
        ...
        args = self._get_dvds_mapped_args(
        )
        return await self._aget_dvds_oapg(
            **kwargs,
        )
    ...
    def get_dvds(
        ...
        return self._get_dvds_oapg(
        )

class GetDvds(BaseApi):
    ...
    async def aget_dvds(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_dvds(
            **kwargs,
        )
    ...
    def get_dvds(
        ...
        raw_response = self.raw.get_dvds(
        )
