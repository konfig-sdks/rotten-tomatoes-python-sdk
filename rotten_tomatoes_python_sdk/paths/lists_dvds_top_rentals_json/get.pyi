...
class BaseApi(api_client.Api):
    ...
    def _get_top_rentals_json_mapped_args(
        self,
    ...
    async def _aget_top_rentals_json_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/dvds/top_rentals.json',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_top_rentals_json_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTopRentalsJsonRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_top_rentals_json(
        self,
        limit: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_top_rentals_json_mapped_args(
            limit=limit,
            country=country,
        )
        return await self._aget_top_rentals_json_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_top_rentals_json(
        self,
        limit: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_top_rentals_json_oapg(
            query_params=args.query,
        )

class GetTopRentalsJson(BaseApi):
    ...
    async def aget_top_rentals_json(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_top_rentals_json(
            limit=limit,
            country=country,
            **kwargs,
        )
    ...
    def get_top_rentals_json(
        ...
        raw_response = self.raw.get_top_rentals_json(
            limit=limit,
            country=country,
        )
