...
class BaseApi(api_client.Api):
    ...
    def _get_upcoming_dvds_mapped_args(
        self,
    ...
    async def _aget_upcoming_dvds_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/dvds/upcoming.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetUpcomingDvdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_upcoming_dvds(
        self,
        page_limit: typing.Optional[str] = None,
        page: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_upcoming_dvds_mapped_args(
            page_limit=page_limit,
            page=page,
            country=country,
        )
        return await self._aget_upcoming_dvds_oapg(
    ...
    def get_upcoming_dvds(
        ...
        return self._get_upcoming_dvds_oapg(
            query_params=args.query,
        )

class GetUpcomingDvds(BaseApi):
    ...
    async def aget_upcoming_dvds(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_upcoming_dvds(
            page_limit=page_limit,
            page=page,
            country=country,
            **kwargs,
    ...
    def get_upcoming_dvds(
        ...
        raw_response = self.raw.get_upcoming_dvds(
            page_limit=page_limit,
            page=page,
            country=country,
        )
