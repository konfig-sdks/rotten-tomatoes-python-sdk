...
class BaseApi(api_client.Api):
    ...
    def _get_box_office_json_mapped_args(
        self,
    ...
    async def _aget_box_office_json_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/movies/box_office.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBoxOfficeJsonRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_box_office_json(
        self,
        limit: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_box_office_json_mapped_args(
            limit=limit,
            country=country,
        )
        return await self._aget_box_office_json_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_box_office_json(
        self,
        limit: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_box_office_json_oapg(
            query_params=args.query,
        )

class GetBoxOfficeJson(BaseApi):
    ...
    async def aget_box_office_json(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_box_office_json(
            limit=limit,
            country=country,
            **kwargs,
        )
    ...
    def get_box_office_json(
        ...
        raw_response = self.raw.get_box_office_json(
            limit=limit,
            country=country,
        )
