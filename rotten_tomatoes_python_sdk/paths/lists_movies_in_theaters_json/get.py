...
class BaseApi(api_client.Api):
    ...
    def _get_intheater_movies_mapped_args(
        self,
    ...
    async def _aget_intheater_movies_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/movies/in_theaters.json',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_intheater_movies_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetIntheaterMoviesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_intheater_movies(
        self,
        page_limit: typing.Optional[str] = None,
        page: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_intheater_movies_mapped_args(
            page_limit=page_limit,
            page=page,
            country=country,
        )
        return await self._aget_intheater_movies_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_intheater_movies(
        self,
        page_limit: typing.Optional[str] = None,
        page: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        ...
        return self._get_intheater_movies_oapg(
            query_params=args.query,
        )

class GetIntheaterMovies(BaseApi):
    ...
    async def aget_intheater_movies(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_intheater_movies(
            page_limit=page_limit,
            page=page,
            country=country,
            **kwargs,
    ...
    def get_intheater_movies(
        ...
        raw_response = self.raw.get_intheater_movies(
            page_limit=page_limit,
            page=page,
            country=country,
        )
