...
class BaseApi(api_client.Api):
    ...
    def _get_opening_movies_mapped_args(
        self,
    ...
    async def _aget_opening_movies_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/movies/opening.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetOpeningMoviesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_opening_movies(
        self,
        limit: typing.Optional[str] = None,
        country: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_opening_movies_mapped_args(
            limit=limit,
            country=country,
        )
        return await self._aget_opening_movies_oapg(
    ...
    def get_opening_movies(
        ...
        return self._get_opening_movies_oapg(
            query_params=args.query,
        )

class GetOpeningMovies(BaseApi):
    ...
    async def aget_opening_movies(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_opening_movies(
            limit=limit,
            country=country,
            **kwargs,
        )
    ...
    def get_opening_movies(
        ...
        raw_response = self.raw.get_opening_movies(
            limit=limit,
            country=country,
        )
