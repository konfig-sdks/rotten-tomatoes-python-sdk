...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'review_type': typing.Union[ReviewTypeSchema, str, ],
...
class BaseApi(api_client.Api):
    ...
    def _get_movie_reviews_mapped_args(
        self,
        id: str,
        ...
        if review_type is not None:
            _query_params["review_type"] = review_type
    ...
    async def _aget_movie_reviews_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/movies/{id}/reviews.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMovieReviewsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_movie_reviews(
        self,
        id: str,
        review_type: typing.Optional[str] = None,
        page_limit: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_movie_reviews_mapped_args(
            id=id,
        ...
        return await self._aget_movie_reviews_oapg(
    ...
    def get_movie_reviews(
        ...
        return self._get_movie_reviews_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMovieReviews(BaseApi):
    ...
    async def aget_movie_reviews(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_movie_reviews(
            id=id,
            review_type=review_type,
            page_limit=page_limit,
            page=page,
    ...
    def get_movie_reviews(
        ...
        raw_response = self.raw.get_movie_reviews(
            id=id,
            review_type=review_type,
            page_limit=page_limit,
            page=page,
