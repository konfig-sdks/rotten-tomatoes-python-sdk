...
from rotten_tomatoes_python_sdk.paths.lists_dvds_new_releases_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsDvdsNewReleasesJson(ApiTestMixin, unittest.TestCase):
    """
    ListsDvdsNewReleasesJson unit test stubs
    """
