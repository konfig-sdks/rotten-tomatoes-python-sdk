...
from rotten_tomatoes_python_sdk.paths.lists_dvds_top_rentals_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsDvdsTopRentalsJson(ApiTestMixin, unittest.TestCase):
    """
    ListsDvdsTopRentalsJson unit test stubs
    """
