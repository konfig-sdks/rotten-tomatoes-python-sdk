...
from rotten_tomatoes_python_sdk.paths.lists_dvds_upcoming_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsDvdsUpcomingJson(ApiTestMixin, unittest.TestCase):
    """
    ListsDvdsUpcomingJson unit test stubs
    """
