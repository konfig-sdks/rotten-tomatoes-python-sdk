...
from rotten_tomatoes_python_sdk.paths.lists_movies_box_office_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsMoviesBoxOfficeJson(ApiTestMixin, unittest.TestCase):
    """
    ListsMoviesBoxOfficeJson unit test stubs
    """
