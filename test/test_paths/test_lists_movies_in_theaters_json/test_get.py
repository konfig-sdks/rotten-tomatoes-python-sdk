...
from rotten_tomatoes_python_sdk.paths.lists_movies_in_theaters_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsMoviesInTheatersJson(ApiTestMixin, unittest.TestCase):
    """
    ListsMoviesInTheatersJson unit test stubs
    """
