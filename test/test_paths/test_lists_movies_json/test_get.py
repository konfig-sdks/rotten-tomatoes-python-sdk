...
from rotten_tomatoes_python_sdk.paths.lists_movies_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsMoviesJson(ApiTestMixin, unittest.TestCase):
    """
    ListsMoviesJson unit test stubs
    """
