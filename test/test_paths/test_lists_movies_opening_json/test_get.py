...
from rotten_tomatoes_python_sdk.paths.lists_movies_opening_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListsMoviesOpeningJson(ApiTestMixin, unittest.TestCase):
    """
    ListsMoviesOpeningJson unit test stubs
    """
