...
from rotten_tomatoes_python_sdk.paths.movie_alias_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMovieAliasJson(ApiTestMixin, unittest.TestCase):
    """
    MovieAliasJson unit test stubs
    """
