...
from rotten_tomatoes_python_sdk.paths.movies_id_clips_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMoviesIdClipsJson(ApiTestMixin, unittest.TestCase):
    """
    MoviesIdClipsJson unit test stubs
    """
