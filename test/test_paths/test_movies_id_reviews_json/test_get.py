...
from rotten_tomatoes_python_sdk.paths.movies_id_reviews_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMoviesIdReviewsJson(ApiTestMixin, unittest.TestCase):
    """
    MoviesIdReviewsJson unit test stubs
    """
