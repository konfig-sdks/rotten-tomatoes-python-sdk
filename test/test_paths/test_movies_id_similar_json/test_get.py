...
from rotten_tomatoes_python_sdk.paths.movies_id_similar_json import get
from rotten_tomatoes_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestMoviesIdSimilarJson(ApiTestMixin, unittest.TestCase):
    """
    MoviesIdSimilarJson unit test stubs
    """
